...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( BASE_WINCE_SRC	src/msw/wince/time.cpp)
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( NET_WINCE_SRC	src/msw/wince/net.cpp)
endif()

if( ${TOOLKIT} MATCHES "WINCE" )
	set( NET_WINCE_HDR	wx/msw/wince/net.h)
endif()
...
if( PLATFORM_UNIX )
	set( GTK_PLATFORM_SRC	${XWIN_LOWLEVEL_SRC})
endif()
...
if( PLATFORM_WIN32 )
	set( GTK_PLATFORM_SRC	${GTK_WIN32_SRC})
endif()

if( PLATFORM_UNIX )
	set( GTK_PLATFORM_HDR	${XWIN_LOWLEVEL_HDR})
endif()
...
if( PLATFORM_WIN32 )
	set( GTK_PLATFORM_HDR	${GTK_WIN32_HDR})
endif()
...
if( PLATFORM_MACOSX )
	set( OSX_LOWLEVEL_SRC	${OSX_LOWLEVEL_SRC})
endif()

if( PLATFORM_MACOSX )
	set( OSX_LOWLEVEL_HDR	${OSX_LOWLEVEL_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "MSW" )
	set( UNIV_PLATFORM_SRC	
        src/msw/evtloop.cpp
    )
endif()

if( ${TOOLKIT} MATCHES "MSW" )
	set( UNIV_PLATFORM_HDR	
        wx/msw/evtloop.h
    )
endif()
...
if( PLATFORM_UNIX )
	set( ADVANCED_GTK_PLATFORM_SRC	${ADVANCED_UNIX_SRC})
endif()
...
if( PLATFORM_WIN32 )
	set( ADVANCED_GTK_PLATFORM_SRC	${ADVANCED_GTK_WIN32_SRC})
endif()

if( PLATFORM_UNIX )
	set( ADVANCED_GTK_PLATFORM_HDR	${ADVANCED_UNIX_HDR})
endif()
...
if( PLATFORM_WIN32 )
	set( ADVANCED_GTK_PLATFORM_HDR	${ADVANCED_GTK_WIN32_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "2" )
...
if( ${TOOLKIT} MATCHES "MSW" )
	set( MSW_HTML_HDR	wx/msw/helpbest.h)
endif()
...
if( ${TOOLKIT} MATCHES "MSW" )
	set( WEBVIEW_SRC_PLATFORM	src/msw/webview_ie.cpp)
endif()

if( ${TOOLKIT} MATCHES "GTK" )
	set( WEBVIEW_SRC_PLATFORM	src/gtk/webview_webkit.cpp)
endif()

if( PLATFORM_MACOSX )
	set( WEBVIEW_SRC_PLATFORM	src/osx/webview_webkit.mm)
endif()
...
if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( OPENGL_SRC_PLATFORM	src/osx/carbon/glcanvas.cpp src/osx/glcanvas_osx.cpp)
endif()

if( ${TOOLKIT} MATCHES "OSX_COCOA" )
	set( OPENGL_SRC_PLATFORM	src/osx/cocoa/glcanvas.mm src/osx/glcanvas_osx.cpp)
endif()

if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( OPENGL_SRC_PLATFORM	src/osx/iphone/glcanvas.mm src/osx/glcanvas_osx.cpp)
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( OPENGL_SRC_PLATFORM	src/cocoa/glcanvas.mm)
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "3" )
	set( OPENGL_SRC_PLATFORM	
        src/unix/glx11.cpp
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( OPENGL_SRC_PLATFORM	
...
if( ${TOOLKIT} MATCHES "MSW" )
	set( OPENGL_SRC_PLATFORM	src/msw/glcanvas.cpp)
endif()
...
if( ${TOOLKIT} MATCHES "MOTIF" )
	set( OPENGL_SRC_PLATFORM	src/x11/glcanvas.cpp src/unix/glx11.cpp)
endif()
...
if( ${TOOLKIT} MATCHES "PM" )
	set( OPENGL_SRC_PLATFORM	src/os2/glcanvas.cpp)
endif()
...
if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( OPENGL_HDR_PLATFORM	wx/osx/glcanvas.h)
endif()
...
if( ${TOOLKIT} MATCHES "COCOA" )
	set( OPENGL_HDR_PLATFORM	wx/cocoa/glcanvas.h)
endif()
...
if( ${TOOLKIT} MATCHES "MSW" )
	set( OPENGL_HDR_PLATFORM	wx/msw/glcanvas.h)
endif()
...
if( ${TOOLKIT} MATCHES "MOTIF" )
	set( OPENGL_HDR_PLATFORM	wx/x11/glcanvas.h wx/unix/glx11.h)
endif()
...
if( ${TOOLKIT} MATCHES "COCOA" )
	set( BASE_OSX_SRC	${BASE_OSX_NOTWXMAC_SRC})
endif()
...
if( PLATFORM_WIN32 )
	set( BASE_PLATFORM_SRC	${BASE_WIN32_SRC} ${BASE_WINCE_SRC})
endif()
...
if( PLATFORM_OS2 )
	set( BASE_PLATFORM_SRC	${BASE_OS2_SRC})
endif()

if( PLATFORM_MSDOS )
	set( BASE_PLATFORM_SRC	${BASE_MSDOS_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( BASE_AND_GUI_TOOLKIT_SRC	${BASE_AND_GUI_OSX_CARBON_SRC})
endif()
...
if( PLATFORM_MSDOS )
	set( BASE_AND_GUI_PLATFORM_SRC	${BASE_AND_GUI_MSDOS_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "COCOA" )
	set( BASE_OSX_HDR	${BASE_OSX_NOTWXMAC_HDR})
endif()
...
if( PLATFORM_WIN32 )
	set( BASE_PLATFORM_HDR	${BASE_WIN32_HDR} ${BASE_WINCE_HDR})
endif()
...
if( PLATFORM_MSDOS )
	set( BASE_PLATFORM_HDR	${BASE_MSDOS_HDR})
endif()

if( PLATFORM_OS2 )
	set( BASE_PLATFORM_HDR	${BASE_OS2_HDR})
endif()
...
if( PLATFORM_WIN32 )
	set( NET_PLATFORM_SRC	${NET_WIN32_SRC} ${NET_WINCE_SRC})
endif()
...
if( PLATFORM_OS2 )
	set( NET_PLATFORM_SRC	${NET_OS2_SRC})
endif()

if( PLATFORM_WIN32 )
	set( NET_PLATFORM_HDR	${NET_WIN32_HDR} ${NET_WINCE_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "2" )
	set( LOWLEVEL_SRC	${GTK2_LOWLEVEL_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( LOWLEVEL_SRC	${GTK1_LOWLEVEL_SRC})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( LOWLEVEL_SRC	${MOTIF_LOWLEVEL_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( LOWLEVEL_SRC	${MSW_LOWLEVEL_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "COCOA" )
	set( LOWLEVEL_SRC	${COCOA_LOWLEVEL_SRC})
endif()

if( ${TOOLKIT} MATCHES "PM" )
	set( LOWLEVEL_SRC	${OS2_LOWLEVEL_SRC})
endif()

if( ${TOOLKIT} MATCHES "X11" )
	set( LOWLEVEL_SRC	${X11_LOWLEVEL_SRC})
endif()

if( ${TOOLKIT} MATCHES "DFB" )
	set( LOWLEVEL_SRC	${DFB_LOWLEVEL_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( LOWLEVEL_HDR	${GTK1_LOWLEVEL_HDR})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( LOWLEVEL_HDR	${MOTIF_LOWLEVEL_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( LOWLEVEL_HDR	${MSW_LOWLEVEL_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "COCOA" )
	set( LOWLEVEL_HDR	${COCOA_LOWLEVEL_HDR})
endif()

if( ${TOOLKIT} MATCHES "PM" )
	set( LOWLEVEL_HDR	${OS2_LOWLEVEL_HDR})
endif()

if( ${TOOLKIT} MATCHES "X11" )
	set( LOWLEVEL_HDR	${X11_LOWLEVEL_HDR})
endif()

if( ${TOOLKIT} MATCHES "DFB" )
	set( LOWLEVEL_HDR	${DFB_LOWLEVEL_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( GUI_SRC	${GTK1_SRC})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( GUI_SRC	${MOTIF_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( GUI_SRC	${MSW_SRC} ${WINCE_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( GUI_SRC	${OSX_CARBON_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( GUI_SRC	${OSX_IPHONE_SRC})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( GUI_SRC	${COCOA_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( GUI_HDR	${GTK1_HDR})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( GUI_HDR	${MOTIF_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( GUI_HDR	${MSW_HDR} ${WINCE_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( GUI_HDR	${OSX_SHARED_HDR} ${OSX_CARBON_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_COCOA" )
	set( GUI_HDR	${OSX_SHARED_HDR} ${OSX_COCOA_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( GUI_HDR	${OSX_SHARED_HDR} ${OSX_IPHONE_HDR})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( GUI_HDR	${COCOA_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_MSW_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_OSX_CARBON_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_OSX_IPHONE_SRC})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_COCOA_SRC})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_UNIX_SRC} ${ADVANCED_MOTIF_SRC})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "2" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_GTK2_SRC})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "3" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_GTK_SRC})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_UNIX_SRC} ${ADVANCED_GTK1_SRC})
endif()

if( ${TOOLKIT} MATCHES "X11" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_UNIX_SRC})
endif()

if( ${TOOLKIT} MATCHES "PM" )
	set( ADVANCED_PLATFORM_SRC	${ADVANCED_OS2_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "WINCE" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_MSW_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_OSX_CARBON_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_OSX_IPHONE_HDR})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_COCOA_HDR})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_UNIX_HDR} ${ADVANCED_MOTIF_HDR})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "2" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_GTK2_HDR})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "3" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_GTK_HDR})
endif()

if( ${TOOLKIT} MATCHES "GTK" AND ${TOOLKIT_VERSION} MATCHES "1" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_UNIX_HDR} ${ADVANCED_GTK1_HDR})
endif()

if( ${TOOLKIT} MATCHES "X11" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_UNIX_HDR})
endif()

if( ${TOOLKIT} MATCHES "PM" )
	set( ADVANCED_PLATFORM_HDR	${ADVANCED_OS2_HDR})
endif()
...
if( NOT WXUNIV )
	set( ADVANCED_SRC	${ADVANCED_CMN_SRC} ${ADVANCED_PLATFORM_SRC} ${ADVANCED_PLATFORM_NATIVE_SRC})
endif()

if( WXUNIV )
	set( ADVANCED_SRC	${ADVANCED_CMN_SRC} ${ADVANCED_PLATFORM_SRC} ${ADVANCED_UNIV_SRC})
endif()

if( NOT WXUNIV )
	set( ADVANCED_HDR	${ADVANCED_CMN_HDR} ${ADVANCED_PLATFORM_HDR} ${ADVANCED_PLATFORM_NATIVE_HDR})
endif()

if( WXUNIV )
	set( ADVANCED_HDR	${ADVANCED_CMN_HDR} ${ADVANCED_PLATFORM_HDR} ${ADVANCED_UNIV_HDR})
endif()

if( ${TOOLKIT} MATCHES "MSW" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_MSW_SRC} ${MEDIA_MSW_DESKTOP_SRC})
endif()

if( ${TOOLKIT} MATCHES "WINCE" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_MSW_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_OSX_CARBON_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_COCOA" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_OSX_COCOA_SRC})
endif()

if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_OSX_IPHONE_SRC})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_COCOA_SRC})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_UNIX_SRC})
endif()

if( ${TOOLKIT} MATCHES "GTK" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_UNIX_SRC} ${MEDIA_GTK_SRC})
endif()
...
if( ${TOOLKIT} MATCHES "PM" )
	set( MEDIA_PLATFORM_SRC	${MEDIA_OS2_SRC})
endif()

if( ${TOOLKIT} MATCHES "MSW" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_MSW_HDR} ${MEDIA_MSW_DESKTOP_HDR})
endif()

if( ${TOOLKIT} MATCHES "WINCE" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_MSW_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_CARBON" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_OSX_CARBON_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_COCOA" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_OSX_COCOA_HDR})
endif()

if( ${TOOLKIT} MATCHES "OSX_IPHONE" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_OSX_IPHONE_HDR})
endif()

if( ${TOOLKIT} MATCHES "COCOA" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_COCOA_HDR})
endif()

if( ${TOOLKIT} MATCHES "MOTIF" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_UNIX_HDR})
endif()
...
if( ${TOOLKIT} MATCHES "PM" )
	set( MEDIA_PLATFORM_HDR	${MEDIA_OS2_HDR})
endif()
...
if( USE_GUI )
	set( GUI_CORE_HEADERS	${GUI_HDR})
endif()

if( USE_GUI )
	set( GUI_CORE_HEADERS	${UNIV_HDR})
endif()
